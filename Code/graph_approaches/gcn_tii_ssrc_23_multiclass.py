...
attack_classification_best_model_params_path = os.path.join(
    "../../Checkpoints/",
    f"tii-ssrc-23-multiclass-gcn-{number_nodes}-{number_eigenvectors}-{embedding_size}.pt",
)
...
evaluation_mode = {
    "mode": "train-test-dev",
    "set": "train",
    "name": "tii-ssrc-23-multiclass-gcn",
}

attack_classification_model = GCN(
...
with open(
    "Results/Pickle/tii-ssrc-23-multiclass-gcn-results-dev.pkl",
    "wb",
) as file:
...
with open(
    "Results/Pickle/tii-ssrc-23-multiclass-gcn-results-test.pkl",
    "wb",
) as file:
    pickle.dump(results, file)
