...
from graph_dataset.graph_dataset import (loadGraphDataset,
...
autoencoder_best_model_params_path = os.path.join(
    "../../Checkpoints/",
    f"cicddos2019-multiclass-autoencoder-{number_nodes}-{number_eigenvectors}-{embedding_size}-{bottleneck_size}.pt",
)
classifier_dnn_best_model_params_path = os.path.join(
    "../../Checkpoints/",
    "cicddos2019-multiclass-classifier-dnn.pt",
)
# +
...
evaluation_mode = {
    "mode": "train-test-dev",
    "set": "train",
    "name": "cicddos2019-multiclass-autoencoder",
}
...
with open(
    "Results/Pickle/cicddos2019-multiclass-autoencoder-results-dev.pkl",
    "wb",
) as file:
...
with open(
    "Results/Pickle/cicddos2019-multiclass-autoencoder-results-test.pkl",
    "wb",
) as file:
    pickle.dump(results, file)
...
print("=" * 89)
with open(
    "Results/Pickle/cicddos2019-multiclass-autoencoder-results-dev.pkl", "rb"
) as file:
...
print("=" * 89)
with open(
    "Results/Pickle/cicddos2019-multiclass-autoencoder-results-test.pkl", "rb"
) as file:
    results = pickle.load(file)
print(
    f"| accuracy: {results['accuracy']} "
