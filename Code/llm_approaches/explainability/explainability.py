...
tokenizer = AutoTokenizer.from_pretrained('/storage/data2/up1072604/saved_tokenizers/Edge/binary')
#
config = AutoConfig.from_pretrained("/storage/data2/up1072604/saved_models/Edge/binary")
model = AutoModelForSequenceClassification.from_pretrained('distilbert-base-uncased',config=config)
#
lora = PeftModel.from_pretrained(model,'/storage/data2/up1072604/saved_models/Edge/binary')
...
###
sequences = pd.read_csv('/storage/data2/up1072604/data/EdgeIIoT_sequences_binary.csv')
