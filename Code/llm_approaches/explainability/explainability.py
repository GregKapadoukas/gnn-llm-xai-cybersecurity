...
tokenizer = AutoTokenizer.from_pretrained('../../../Checkpoints/saved_tokenizers/Edge/binary')
#
config = AutoConfig.from_pretrained("../../../Checkpoints/saved_models/Edge/binary")
model = AutoModelForSequenceClassification.from_pretrained('distilbert-base-uncased',config=config)
#
lora = PeftModel.from_pretrained(model,'../../../Checkpoints/saved_models/Edge/binary')
...
###
sequences = pd.read_csv('../../../Datasets/Edge-IIoTset Cyber Security Dataset of IoT & IIoT/EdgeIIoT_sequences_binary.csv')
