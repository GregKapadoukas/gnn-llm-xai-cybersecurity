...
evaluation_mode = {
    "mode": "train-test-dev",
    "set": "train",
    "name": "cicddos2019-multiclass-gcn",
}

classification_model = GCN(
...
print("Evaluating DDoS classification model on dev set")
results = evaluate(
    classification_model,
    classification_best_model_params_path,
    loss_function,
...
with open(
    "Results/Pickle/cicddos2019-multiclass-gcn-results-dev.pkl",
    "wb",
) as file:
    pickle.dump(results, file)

evaluation_mode["set"] = "test"
print("Evaluating DDoS classification model on test set")
results = evaluate(
    classification_model,
    classification_best_model_params_path,
    loss_function,
...
with open(
    "Results/Pickle/cicddos2019-multiclass-gcn-results-test.pkl",
    "wb",
) as file:
    pickle.dump(results, file)
...
print("=" * 89)
with open("Results/Pickle/cicddos2019-multiclass-gcn-results-dev.pkl", "rb") as file:
...
print("=" * 89)
with open("Results/Pickle/cicddos2019-multiclass-gcn-results-test.pkl", "rb") as file:
    results = pickle.load(file)
print(
    f"| accuracy: {results['accuracy']} "
    f"| macro precision: {results['precision']}\n"
