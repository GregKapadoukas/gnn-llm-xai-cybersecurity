...
detection_best_model_params_path = os.path.join(
    "../../Checkpoints/",
    f"cicddos2019-binary-{number_nodes}-{number_eigenvectors}-{embedding_size}.pt",
)
# +
...
detection_model = GraphTransformer(
...
with open(
    "Results/Pickle/cicddos2019-binary-results-dev.pkl",
    "wb",
) as file:
...
with open(
    "Results/Pickle/cicddos2019-binary-results-test.pkl",
    "wb",
) as file:
    pickle.dump(results, file)
...
print("=" * 89)
with open("Results/Pickle/cicddos2019-binary-results-dev.pkl", "rb") as file:
...
print("=" * 89)
with open("Results/Pickle/cicddos2019-binary-results-test.pkl", "rb") as file:
    results = pickle.load(file)
print(
    f"| accuracy: {results['accuracy']} "
    f"| macro precision: {results['precision']}\n"
