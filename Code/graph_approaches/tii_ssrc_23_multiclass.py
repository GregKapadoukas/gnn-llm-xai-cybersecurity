...
attack_classification_best_model_params_path = os.path.join(
    "../../Checkpoints/",
    f"tii-ssrc-23-multiclass-{number_nodes}-{number_eigenvectors}-{embedding_size}.pt",
)
...
attack_classification_model = GraphTransformer(
...
with open(
    "Results/Pickle/tii-ssrc-23-multiclass-results-dev.pkl",
    "wb",
) as file:
...
with open(
    "Results/Pickle/tii-ssrc-23-multiclass-results-test.pkl",
    "wb",
) as file:
    pickle.dump(results, file)
...
print("=" * 89)
with open("Results/Pickle/tii-ssrc-23-multiclass-results-dev.pkl", "rb") as file:
...
print("=" * 89)
with open("Results/Pickle/tii-ssrc-23-multiclass-results-test.pkl", "rb") as file:
    results = pickle.load(file)
print(
    f"| accuracy: {results['accuracy']} "
    f"| macro precision: {results['precision']}\n"
...
# Start thorughput evaluation on one GPU
evaluation_mode["set"] = "test"
print("Evaluating attack classification model on test set")
for i in range(100):
    print(f"Throughput evaluation {i} on test set")
    results = throughput_evaluate(
        attack_classification_model,
        attack_classification_best_model_params_path,
        graphs_test,
        labels_test,
