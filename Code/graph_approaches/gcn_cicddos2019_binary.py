...
detection_best_model_params_path = os.path.join(
    "../../Checkpoints/",
    "cicddos2019-binary-gcn.pt",
)
# +
...
for epoch_num in range(1, epochs + 1):
    ...
    if train_loss < best_train_loss:
        ...
        torch.save(
            detection_model.state_dict(),
            detection_best_model_params_path,
        )
print("=" * 89)
...
print("Evaluating DDoS detection model on dev set")
results = evaluate(
    detection_model,
    detection_best_model_params_path,
    loss_function,
...
with open(
    "Results/Pickle/cicddos2019-binary-gcn-results-dev.pkl",
    "wb",
) as file:
    pickle.dump(results, file)

evaluation_mode["set"] = "test"
print("Evaluating DDoS detection model on test set")
results = evaluate(
    detection_model,
    detection_best_model_params_path,
    loss_function,
...
with open(
    "Results/Pickle/cicddos2019-binary-gcn-results-test.pkl",
    "wb",
) as file:
    pickle.dump(results, file)
...
print("=" * 89)
with open("Results/Pickle/cicddos2019-binary-gcn-results-dev.pkl", "rb") as file:
...
print("=" * 89)
with open("Results/Pickle/cicddos2019-binary-gcn-results-test.pkl", "rb") as file:
    results = pickle.load(file)
print(
    f"| accuracy: {results['accuracy']} "
    f"| macro precision: {results['precision']}\n"
